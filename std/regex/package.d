...
import std.regex.ir;
import std.regex.thompson; //TODO: get rid of this dependency
...
+/
public alias Regex(Char) = std.regex.ir.Regex!(Char);
...
+/
public alias StaticRegex(Char) = std.regex.ir.StaticRegex!(Char);
...
{
    import std.regex.parser, std.regex.backtracking;
...
public alias RegexException = std.regex.ir.RegexException;
